...
`TODO://` Add the URL to your animated app walkthough `gif` in the image tag below, `WalkThrough3)`. 

<img src="https://github.com/muirallan/Flixster/blob/master/Walkthroughflickers3.gif" width=250><br>
